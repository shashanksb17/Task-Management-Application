...
export const TaskCard = ({ taskData, fetchTaskData }) => {
  ...
  const handleEditSubmit = (values) => {
    axios
      .patch(
        `https://task-management-application-v0f3.onrender.com/task/edit/${selectedTask?._id}`,
        values,
        {
          headers: {
  ...
  const DeleteTask = (taskId) => {
    return () => {
      axios
        .delete(`https://task-management-application-v0f3.onrender.com/task/delete/${taskId}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
